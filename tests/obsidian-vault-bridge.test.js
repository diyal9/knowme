...
describe('obsidian vault bridge', () => {
  ...
  it('exposes fixed IPC APIs and removes the embedded graph bridge', () => {
    ...
    assert.match(main, /ipcMain\.handle\('obsidian-status'/)
    assert.match(main, /ipcMain\.handle\('obsidian-install'/)
    assert.match(main, /ipcMain\.handle\('obsidian-bridge-install'/)
    assert.match(main, /ipcMain\.handle\('obsidian-open'/)
