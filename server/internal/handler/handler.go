...
func (s *Server) Register(r *gin.Engine) {
	...
	admin.PUT("/plans/:id", s.adminUpsertPlan)
	admin.GET("/activations", s.adminActivations)
	admin.GET("/activation-codes", s.adminActivationCodes)
	admin.PUT("/activations/:id/status", s.adminSetActivationStatus)
	admin.POST("/activations/:id/extend", s.adminExtendActivation)
