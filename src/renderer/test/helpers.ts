...
export function mockApi(partial: Partial<KnowMeApi> = {}): KnowMeApi {
  const api = {
    ...
    expertTaskPreparePlanConfirmation: async () => ({ ok: true, token: 'test-plan-confirmation-token' }),
    ...
    agentSessionClearHistory: async () => ({ ok: true, session: { id: 'cleared', title: '新助手', agentId: 'personal' } }),
