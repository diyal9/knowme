...
/** Finds the slash query immediately before the caret, including inside a sentence. */
export function getSlashContext(value: string, caret: number): SlashContext | null {
...
export function removeSlashSkillMarker(
  value: string,
  name: string,
): { next: string; caret: number } {
