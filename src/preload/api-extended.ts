...
module.exports = {
  ...
  agentRegistryVerify: payload => ipcRenderer.invoke('agent-registry-verify', payload || {}),
  agentRegistryPreview: payload => ipcRenderer.invoke('agent-registry-preview', payload || {}),
  agentRegistryCommit: payload => ipcRenderer.invoke('agent-registry-commit', payload || {}),
  agentRegistryRevisions: payload => ipcRenderer.invoke('agent-registry-revisions', payload || {}),
  agentRegistryDraftGet: payload => ipcRenderer.invoke('agent-registry-draft-get', payload || {}),
  agentRegistryDraftSave: payload => ipcRenderer.invoke('agent-registry-draft-save', payload || {}),
