...
module.exports = {
  ...
  artifactPreviewResolve: source => ipcRenderer.invoke('artifact-preview-resolve', String(source || '')),
  ...
  agentSessionClearHistory: () => ipcRenderer.invoke('agent-session-clear-history'),
  ...
  brainSnapshot: options => ipcRenderer.invoke('brain-snapshot', options),
  brainNeighborhood: payload => ipcRenderer.invoke('brain-neighborhood', payload),
  brainQuery: request => ipcRenderer.invoke('brain-query', request),
  brainNodeGet: id => ipcRenderer.invoke('brain-node-get', id),
  brainExplain: ref => ipcRenderer.invoke('brain-explain', ref),
  brainPath: payload => ipcRenderer.invoke('brain-path', payload),
  brainProposalList: options => ipcRenderer.invoke('brain-proposal-list', options),
  brainProposalCreate: payload => ipcRenderer.invoke('brain-proposal-create', payload),
  brainObserve: payload => ipcRenderer.invoke('brain-observe', payload),
  brainReferenceSave: payload => ipcRenderer.invoke('brain-reference-save', payload),
  brainProposalConfirm: payload => ipcRenderer.invoke('brain-proposal-confirm', payload),
  brainProposalReject: id => ipcRenderer.invoke('brain-proposal-reject', id),
  brainProposalSnooze: id => ipcRenderer.invoke('brain-proposal-snooze', id),
  brainForget: id => ipcRenderer.invoke('brain-forget', id),
  brainRebuild: () => ipcRenderer.invoke('brain-rebuild'),
  brainProviderSync: id => ipcRenderer.invoke('brain-provider-sync', id),
  brainLayoutSave: positions => ipcRenderer.invoke('brain-layout-save', positions || {}),
  brainGrowthList: options => ipcRenderer.invoke('brain-growth-list', options || {}),
  brainGrowthUndo: id => ipcRenderer.invoke('brain-growth-undo', id),
  ...
  taskCapabilityGrantsList: sessionId => ipcRenderer.invoke('task-capability-grants-list', String(sessionId || '')),
  taskCapabilityGrantRevoke: payload => ipcRenderer.invoke('task-capability-grant-revoke', payload || {}),
  ...
  expertTaskPreparePlanConfirmation: payload => ipcRenderer.invoke('expert-task-prepare-plan-confirmation', payload || {}),
