...
const api = {
  ...
  onAttentionToastInit: cb => ipcRenderer.on('attention-toast-init', (_e, payload) => cb(payload)),
  onAttentionOpen: cb => ipcRenderer.on('attention-open', (_e, payload) => cb(payload)),
}
