...
const TOOL_USER_LABELS = {
  ...
  'verify_agent_definition': '校验 Agent 专业定义',
  'preview_agent_change': '预览 Agent 变更',
  'commit_agent_change': '提交 Agent 变更',
  'list_agent_revisions': '查看 Agent 历史版本',
  'get_agent_draft': '读取 Agent 草稿',
  'update_agent_draft': '更新 Agent 草稿',
  'check_agent_eval_runtime': '检查 Agent 评估环境',
  'setup_agent_eval_runtime': '安装 Agent 评估环境',
  'save_agent_eval_suite': '保存 Agent 评估集',
  'run_agent_eval': '运行 Agent 评估',
  'get_agent_eval_report': '读取 Agent 评估报告',
