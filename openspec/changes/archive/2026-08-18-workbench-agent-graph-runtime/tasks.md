...
- [x] 4.1 Add unit and integration coverage for composition compilation, Team Runner startup, handoff, gate, terminal and failure paths.
- [x] 4.2 Add Electron smoke coverage for goal → graph proposal → confirmation → multi-Agent Run → gate → result/reload.
- [x] 4.3 Add feature-flag fallback coverage proving legacy local and Daemon paths remain usable.
